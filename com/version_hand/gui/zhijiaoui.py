...
class Ui_zhijiaoUi(object):
    def setupUi(self, zhijiaoUi):
        ...
        zhijiaoUi.setWindowOpacity(0.8)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 360, 571, 22))
        ...
        self.widget.setGeometry(QtCore.QRect(30, 330, 571, 22))
        ...
        self.progressBar_total = QtWidgets.QProgressBar(self.widget)
